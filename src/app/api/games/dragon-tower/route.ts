...
const LEVEL_MULTIPLIERS: Record<string, number[]> = {
  easy:   [1.01, 1.05, 1.10, 1.15, 1.25, 1.40, 1.70, 2.10, 2.70],
  medium: [1.10, 1.30, 1.60, 2.00, 2.60, 3.40, 4.50, 6.00, 8.5],
  hard:   [1.50, 2.20, 3.30, 5.00, 7.50, 12.0, 18.0, 30.0, 45.0],
  expert: [3.00, 7.00, 16.0, 30.0, 60.0, 100, 160, 250, 380],
};
